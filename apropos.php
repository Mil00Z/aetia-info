...
<head>
  ...
  <title> Aetia Informatique - A propos </title>
  ...
  <meta property="og:type" content="Website" />
    <meta property="og:url" content="http://www.aetia.fr/aetia" />
              ...
              <div class="services_content--title">
                  ...
                  <h3>Sous titre éventuel</h3>
                    ...
                    <ul class="timeline_container">
                      ...
                      <li>Création d'Aetia</li>
                      <span class="timeline--date">2007</span>
                      <li>Création de l'agence de Quimper</li>
                      <span class="timeline--date">2008</span>
                      <li>Acquisition de
                          <a href="http://www.cornouaille-informatique.fr/" target="_blank">Cornouaille Informatique</a></li>
                      <span class="timeline--date">2011</span>
                      <li>Création de l'agence de Saint Brieuc</li>
                      <span class="timeline--date">2014</span>
                      <li>Création des bureaux de Brest</li>
                      <span class="timeline--date">2014</span>
                      <li>Aetia déménage dans son nouveau siège de Lorient</li>
                      <span class="timeline--date">2017</span>
                      <li>Création du réseau Winnov regroupant les sociétés partenaires de l'écosystème Aetia</li>
                      <span class="timeline--date">2017</span>
                      <li><a href="http://www.infosup.fr/" target="_blank">Infosup</a>, Editeurs de solutions métiers dans le domaine du bâtiment et du <a href="http://www.infosup-voyages.fr/" targe="_blank">tourisme</a> rejoint le Réseau Winnov</li>
                  </ul>
          ...
          <section id="direction" class="container-fluid logiciels">
              ...
              <div class="logiciels-presentation_content container">
                  ...
                  <div class="row persona-slider">
                            ...
                            <div class="col-lg-4 persona_container">
