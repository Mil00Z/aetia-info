...
<head>
  ...
  <title> Aetia Informatique - Page Not Found </title>
  ...
  <meta property="og:type" content="Website" />
    <meta property="og:url" content="http://www.aetia.fr/404" />
    ...
    <!-- Contenu Principal-->
      <main>
          ...
          <section id="error-404" class="">
                ...
                <div class="error-404_block container">

                    <div class="error-404_top">

                        <img class="img-404" src="assets/img/icon/404.svg">

                        <h1 aria-label="page 404">Page introuvable</h1>
                    </div>

                    <div class="error-404_content">

                    <p>Vous êtes perdu ?</p>
                    <p> Retrouvez votre chemin ici : </p>

                </div>

                    <form class="form-block" action="index.php" method="" >

                        <input type="search" class="search" placeholder="votre recherche">
                        <button>Ok</button>
