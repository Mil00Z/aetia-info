...
<head>
  ...
  <title> Aetia Informatique - Matériels et Infrasctructure  </title>
...
<!--      navigations matériels et infra-->
...
<!--          comme pour solutions, injecter la bonne nav et le bon contenu en fonction des choix-->
              <?php require_once ('block/distribution_info.php') ;?>
              <?php require_once ('block/solution_sauv.php') ;?>
              <?php require_once ('block/integration_reseaux.php') ;?>
              <?php require_once ('block/secur_telecom.php') ;?>
              <?php require_once ('block/replication_restau.php') ;?>
